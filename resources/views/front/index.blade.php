...
@section('contact')
                ...
                <div class="row align-items-center">
                        ...
                        <div class="banner-text">
                            <div class="banner-content">
                                ...
                                <a data-animation="fadeInUp" data-delay="1.1s"
                                   class="main-btn rounded-btn icon-right small-size" href="{{route('home.services')}}">
                    ...
                    <div class="col-lg-5 d-none d-lg-block positiona">
                        <div class="banner-img hexagon" data-animation="fadeInRight" data-delay="0.5s">
                            <div class="shape">
                                <img src="{{asset('front/assets/img/banner/banner-04.jpg')}}" alt="Banner">
                            </div>
                        </div>
                    </div>
            ...
            <div class="container-fluid container-1470">
                <div class="row align-items-center ">
                    ...
                    <div class="col-lg-5 d-none d-lg-block">
                        <div class="banner-img hexagon" data-animation="fadeInRight" data-delay="0.5s">
                            <div class="shape">
                                <img class="" height="100%" src="{{asset('front/assets/img/banner/banner-img.png')}}" alt="Banner">
                            </div>
                        </div>
                    </div>
            ...
            <div class="row service-items">
                    ...
                    <div class="service-item color-2 text-center mt-30">
                        <div class="icon hexagon">
                            <div class="shape change-1">
                                <img class="" height="100%" src="{{asset('front/assets/img/service-img/SERVICES-safe.jpg')}}" alt="Banner">
                            </div>
                        </div>
                    ...
                    <div class="service-item color-1 text-center mt-30">
                        <div class="icon hexagon">
                            <div class="shape chang">
                                <img class="" height="100%" src="{{asset('front/assets/img/service-img/adviec-safe.jpg')}}" alt="Banner">
                            </div>
                        </div>
                    ...
                    <div class="service-item color-3 text-center mt-30">
                        <div class="icon hexagon">
                            <div class="shape change-2">
                                <img class="" height="100%" src="{{asset('front/assets/img/service-img/post-safe.jpg')}}" alt="Banner">
                            </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay="0.9s">
                    <div class="service-item color-4 text-center mt-30">
                        <div class="icon hexagon">
                            <div class="shape change-1">
                                <img class="" height="100%" src="{{asset('front/assets/img/service-img/control-safe.jpg')}}" alt="Banner">
                            </div>
                        </div>
                        <h5 class="title"><a href="service-details.html">Access control</a></h5>
                ...
                <div class="col-lg-6 order-lg-2 col-md-9">
                    <div class="tile-gallery-two">
                        <div class="img-one wow fadeInLeft" data-wow-delay="0.3s">
                            <img src="{{asset('front/assets/img/tile-gallery/tile-gallery-03.jpg')}}" alt="Image">
                        </div>
                        <div class="img-two text-right wow fadeInUp" data-wow-delay="0.4s">
                            <img src="{{asset('front/assets/img/tile-gallery/tile-gallery-04.jpg')}}" alt="Image">
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-6 col-md-10">
                    <div class="tile-gallery-one wow fadeInLeft" data-wow-delay="0.3s">
                        <div class="img-one">
                            <img src="{{asset('front/assets/img/tile-gallery/tile-gallery-01.jpg')}}" alt="Image">
                        </div>
                        <div class="img-two text-right wow fadeInUp" data-wow-delay="0.5s">
                            <img src="{{asset('front/assets/img/tile-gallery/tile-gallery-02.jpg')}}" alt="Image">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-10">
            ...
            <div class="row service-items justify-content-center">
                <div class="col-lg-4 col-md-6 col-sm-10 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item-two color-1 mt-30">
                        <div class="icon">
                            <img src="{{asset('front/assets/img/icon/solutions-1.jpg')}}" alt="">
                        </div>
                        <h3 class="title"><a href="{{route('home.show-services')}}">Employee registration and communication</a>
                        </h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-10 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="service-item-two color-2 mt-30">
                        <div class="icon">
                            <img src="{{asset('front/assets/img/icon/solutions-2.jpg')}}" alt="">
                        </div>
                        <h3 class="title style-titel"><a href="{{route('home.show-services')}}">Travel and accommodation
                                management</a></h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-10 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item-two color-3 mt-30 systems">
                        <div class="icon">
                            <img src="{{asset('front/assets/img/icon/solutions-3.jpg')}}" alt="">
                        </div>
                        <h3 class="title"><a href="{{route('home.show-services')}}">Expense management</a></h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-10 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="service-item-two color-3 mt-30">
                        <div class="icon">
                            <img src="{{asset('front/assets/img/icon/solutions-4.jpg')}}" alt="">
                        </div>
                        <h3 class="title titel-style"><a href="{{route('home.show-services')}}">Planning and coordination</a></h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-10 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="service-item-two color-1 mt-30">
                        <div class="icon">
                            <img src="{{asset('front/assets/img/icon/solutions-5.jpg')}}" alt="">
                        </div>
                        <h3 class="title titel-style"><a href="{{route('home.show-services')}}">Activity and Itinerary
                                Management</a></h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-10 wow fadeInUp" data-wow-delay="0.8s">
                    <div class="service-item-two color-4 mt-30">
                        <div class="icon">
                            <img src="{{asset('front/assets/img/icon/solutions-6.jpg')}}" alt="">
                        </div>
                        <h3 class="title Titel-pad"><a href="{{route('home.show-services')}}">Sharing documents and resources</a>
                        </h3>
        ...
        <div class="container">
            ...
            <div class="portfolio-items portfolio-slider-one row ">
                ...
                <div class="col-lg-4">
                    <div class="portfolio-item">
                        <div class="portfolio-img">
                            <img src="{{asset('front/assets/img/portfolio/01.jpg')}}" alt="Image">
                        </div>
                        <div class="portfolio-content">
                            ...
                            <a href="{{route('home.OurPortfolio')}}" class="portfolio-link"><i
                ...
                <div class="col-lg-4">
                    <div class="portfolio-item">
                        <div class="portfolio-img">
                            <img src="{{asset('front/assets/img/portfolio/02.jpg')}}" alt="Image">
                        </div>
                        <div class="portfolio-content">
                            <div class="item textalignr">
                                <span class="category">IT / Solutions </span>
                ...
                <div class="col-lg-4">
                    <div class="portfolio-item">
                        <div class="portfolio-img">
                            <img src="{{asset('front/assets/img/portfolio/03.jpg')}}" alt="Image">
                        </div>
                        <div class="portfolio-content">
                            <div class="item textalignr">
                                <span class="category">IT / Solutions </span>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6 col-sm-9 wow fadeInLeft" data-wow-delay="0.3s">
                    <div class="service-item-four no-border mt-50">
                        <div class="services-thumb">
                            <img src="{{asset('front/assets/img/service-img/13.jpg')}}" alt="Service-Image">
                        </div>
                        <div class="services-content">
                            <div class="icon">
                                <img src="{{asset('front/assets/img/icon/settings.png')}}" alt="Icon">
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-9 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item-four no-border mt-50">
                        <div class="services-thumb">
                            <img src="{{asset('front/assets/img/service-img/14.jpg')}}" alt="Service-Image">
                        </div>
                        <div class="services-content">
                            <div class="icon">
                                <img src="{{asset('front/assets/img/icon/microchip.png')}}" alt="Icon">
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-9 wow fadeInRight" data-wow-delay="0.3s">
                    <div class="service-item-four no-border mt-50">
                        <div class="services-thumb">
                            <img src="{{asset('front/assets/img/service-img/15.jpg')}}" alt="Service-Image">
                        </div>
                        <div class="services-content">
                            <div class="icon">
                                <img src="{{asset('front/assets/img/icon/press.png')}}" alt="Icon">
                            </div>
            ...
            <div class="row testimonials-slider-two">
                    ...
                    <div class="testimonial-box-two mb-30 directionslider">
                        <div class="testimonial-inner">
                            <div class="testimonial-img">
                                <img src="{{asset('front/assets/img/testimonial-one.jpg')}}" alt="Image">
                ...
                <div class="col-lg-6">
                    <div class="testimonial-box-two mb-30 directionslider">
                        <div class="testimonial-inner">
                            <div class="testimonial-img">
                                <img src="{{asset('front/assets/img/testimonial-two.jpg')}}" alt="Image">
                                <i class="fas fa-quote-left"></i>
                            </div>
                            <div class="content">
                                <p>
    ...
    <section class="call-to-action" style="background-image: url({{asset('front/assets/img/cta-bg/cta-bg.jpg')}});">
        <div class="container">
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6 col-sm-8 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="latest-news-box mt-30">
                        <div class="post-thumb">
                            <img src="{{asset('front/assets/img/latest-news/01.jpg')}}" alt="Image">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-8 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="latest-news-box mt-30">
                        <div class="post-thumb">
                            <img src="{{asset('front/assets/img/latest-news/02.jpg')}}" alt="Image">
                        </div>
                        <div class="post-content">
                            <ul class="post-meta">
                                <li><a href="#">By Admin,</a></li>
                ...
                <div class="col-lg-4 col-md-6 col-sm-8 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="latest-news-box mt-30">
                        <div class="post-thumb">
                            <img src="{{asset('front/assets/img/latest-news/03.jpg')}}" alt="Image">
                        </div>
                        <div class="post-content">
                            <ul class="post-meta">
                                <li><a href="#">By Admin,</a></li>
